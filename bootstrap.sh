...
numbered_commits=(
    ...
    025_5c60bc1f68efb3f957730bd97eb4607415368dd4  # Ideally bootstrap_transpiler.py would start here...
)

# This should be an item of the above list according to what
# bootstrap_transpiler.py supports.
bootstrap_transpiler_numbered_commit=025_5c60bc1f68efb3f957730bd97eb4607415368dd4
