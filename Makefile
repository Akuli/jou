...
test: all
	...
	tests/runtests.sh --skip-expected-fails 'valgrind -q --error-exitcode=1 --leak-check=full --show-leak-kinds=all --num-callers=100 --suppressions=valgrind-suppressions.sup ./jou %s'
